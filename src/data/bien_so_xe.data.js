...
export const BannerDataSource = {
    ...
    children: [
      {
        ...
        children: <p>Biển số xe</p>
      },
      {
        name: "content",
        className: "banner5-description",
        children: (
          <p>Nhận diện và trích xuất thông tin từ hình ảnh của biển số xe</p>
        )
      },
      {
        name: "button",
  ...
  image: {
    ...
    children: "/banner7.jpg"
  },
  image2: {
    className: "banner5-image",
    children: "/banner7_1.jpg"
  }
};
  ...
  childWrapper: {
    ...
    children: [
      ...
      },
      {
        ...
        xs: 24,
        children: {
          to: "/products/ocr/vehicle-registration",
          imgSource: "/related05.jpg",
          title: "Nhận diện giấy đăng ký xe",
...
export const FAQDataSource = {
  ...
  content: [
    ...
    {
      header: "Sản phẩm nhận diện biển số xe được tính phí thế nào?",
      key: "4",
      text:
        "Thông thường các sản phẩm của CVS Vision được tính phí theo số lượt sử dụng. Mỗi lượt sử dụng được tính là một lần gửi hình ảnh biển số xe lên CVS Vision API và nhận được kết quả là thông tin trích xuất thành công từ hình ảnh gửi lên. Nếu doanh nghiệp của bạn có số lượng lớn giấy tờ cần xử lý, hãy liên hệ với chúng tôi để có giải pháp sử dụng tối ưu nhất cho doanh nghiệp của bạn."
    },
    {
      header:
...
export const BenefitDataSource = {
  ...
  content1: [
    {
      img: <img src="/benefit12.svg" alt="img" />,
      title: "Độ chính xác trên 98%"
    },
    {
