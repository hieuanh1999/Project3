    ...
    children: [
      {
        ...
        children: <p>Nhận diện văn bản</p>
      },
      {
        name: "content",
    ...
    children: [
      {
        ...
        children: {
          ...
          title: "Nhận diện dữ liệu dạng bảng",
          description:
...
export const FAQDataSource = {
  ...
  content: [
    ...
    {
      header: "Sản phẩm nhận diện văn bản được tính phí thế nào?",
      key: "4",
      text:
        "Sản phẩm Nhận diện văn bản được tính phí theo số trang của văn bản. Nếu doanh nghiệp của bạn có số lượng lớn giấy tờ cần xử lý, hãy liên hệ với chúng tôi để có giải pháp sử dụng tối ưu nhất cho doanh nghiệp của bạn."
    },
    {
      header:
