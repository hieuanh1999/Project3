...
export const BannerDataSource = {
  ...
  childWrapper: {
    ...
    children: [
      ...
      },
      {
        ...
        children: (
          <p>
            Nhận diện và phân tách thông tin từ mã MRZ trên hình ảnh của Hộ
            chiếu tất cả quốc gia.
          </p>
        )
      },
      {
  ...
  image: {
    ...
    children: "/banner11.jpg"
  },
  image2: {
    className: "banner5-image",
    children: "/banner11_1.jpg"
  }
};
  ...
  childWrapper: {
    ...
    children: [
      ...
      },
      {
        ...
        xs: 24,
        children: {
          to: "/products/facial-recognition/face-verification",
          imgSource: "/related14.jpg",
          title: "So khớp ảnh selfie và giấy tờ tùy thân",
          description:
...
export const FAQDataSource = {
  ...
  content: [
    ...
    {
      header: "Sản phẩm nhận diện hộ chiếu quốc tế được tính phí thế nào?",
      key: "4",
      text:
        "Thông thường các sản phẩm của CVS Vision được tính phí theo số lượt sử dụng. Mỗi lượt sử dụng được tính là một lần gửi hình ảnh của Hộ chiếu lên CVS Vision API và nhận được kết quả là thông tin trích xuất thành công từ hình ảnh gửi lên. Nếu doanh nghiệp của bạn có số lượng lớn giấy tờ cần xử lý, hãy liên hệ với chúng tôi để có giải pháp sử dụng tối ưu nhất cho doanh nghiệp của bạn."
    },
    {
      header:
...
export const BenefitDataSource = {
  ...
  content1: [
    {
      img: <img src="/benefit09.svg" alt="img" />,
      title: "Độ chính xác trên 92%"
    },
    {
