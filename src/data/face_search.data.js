    ...
    children: [
      {
        ...
        children: <p>Tìm kiếm khuôn mặt</p>
      },
      {
        name: "content",
        ...
        children: (
          <p>
            Tìm kiếm khuôn mặt tốc độ cao trên tập hàng chục triệu khuôn mặt.
          </p>
        )
      },
      {
...
export const FAQDataSource = {
  ...
  content: [
    ...
    {
      header: "Sản phẩm tìm kiếm khuôn mặt được tính phí thế nào?",
      key: "4",
      text:
        "Thông thường các sản phẩm của CVS Vision được tính phí theo số lượt sử dụng. Mỗi lượt sử dụng được tính là một lần gửi hình ảnh khuôn mặt lên để xử lý. Nếu doanh nghiệp của bạn có số lượng lớn giấy tờ cần xử lý, hãy liên hệ với chúng tôi để có giải pháp sử dụng tối ưu nhất cho doanh nghiệp của bạn."
    },
    {
      header:
