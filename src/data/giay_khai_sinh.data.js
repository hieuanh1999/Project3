...
export const BannerDataSource = {
  ...
  childWrapper: {
    ...
    children: [
      ...
      },
      {
        ...
        children: (
          <p>
            Nhận diện và trích xuất thông tin từ hình ảnh của giấy khai sinh
          </p>
        )
      },
      {
  ...
  image: {
    ...
    children: "/banner8.jpg"
  },
  image2: {
    className: "banner5-image",
    children: "/banner8_1.jpg"
  }
};
  ...
  childWrapper: {
    ...
    children: [
      ...
      },
      {
        ...
        xs: 24,
        children: {
          to: "/products/ocr/table",
          imgSource: "/related10.jpg",
          title: "Nhận diện dữ liệu bảng",
          description:
            "Nhận diện và trích xuất thông tin từ hình ảnh của các loại dữ liệu dạng bảng như báo cáo tài chính, bảng kê viện phí, bảng điểm, sao kê ngân hàng...."
        }
      },
      {
        name: "block1",
        ...
        xs: 24,
        children: {
          to: "/products/ocr/image-to-text",
          imgSource: "/related11.jpg",
          title: "Nhận diện văn bản",
          description:
            "Chuyển thông tin từ dạng hình ảnh sang văn bản phục vụ việc tìm kiếm nội dung"
        }
      }
    ]
  }
...
export const FAQDataSource = {
  ...
  content: [
    ...
    {
      header: "Sản phẩm nhận diện giấy khai sinh được tính phí thế nào?",
      key: "4",
      text:
        "Thông thường các sản phẩm của CVS Vision được tính phí theo số lượt sử dụng. Mỗi lượt sử dụng được tính là một lần gửi hình ảnh giấy khai sinh lên CVS Vision API và nhận được kết quả là thông tin trích xuất thành công từ hình ảnh gửi lên. Nếu doanh nghiệp của bạn có số lượng lớn giấy tờ cần xử lý, hãy liên hệ với chúng tôi để có giải pháp sử dụng tối ưu nhất cho doanh nghiệp của bạn."
    },
    {
      header:
...
export const BenefitDataSource = {
  ...
  content1: [
    ...
    {
      img: <img src="/benefit10.svg" alt="img" />,
      title: "Nhanh hơn 30 lần nhập thủ công"
    },
    {
  ...
  content2: [
    {
      ...
      title: "Nhận diện từ ảnh chất lượng kém"
    },
    {
