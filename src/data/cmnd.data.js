...
export const BannerDataSource = {
    ...
    children: [
      {
        ...
        children: <p>Nhận diện thông tin giấy tờ tùy thân</p>
      },
      {
        name: "content",
        ...
        children: (
          <p>
            Nhận diện thông tin từ hình ảnh của các loại giấy tờ tùy thân như
            CMND 9 số, CMND 12 số, Căn cước công dân, CCCD gắn chip, Hộ chiếu,
            Giấy phép lái xe.
          </p>
        )
      },
  ...
  image: {
    ...
    children: "/banner2.jpg"
  },
  image2: {
    className: "banner5-image",
    children: "/banner2_1.jpg"
  }
};
  ...
  childWrapper: {
    ...
    children: [
      ...
      },
      {
        ...
        xs: 24,
        children: {
          to: "/products/ocr/myanmar-id-card",
          imgSource: "/related02.jpg",
          title: "Nhận diện ID Card Myanmar",
          description: "Nhận diện thông tin từ ảnh chụp ID Card Myanmar"
        }
      },
      {
        name: "block2",
...
export const FAQDataSource = {
  ...
  content: [
    ...
    {
      header: "Sản phẩm nhận diện giấy tờ tùy thân được tính phí thế nào?",
      key: "4",
      text:
        "Thông thường các sản phẩm của CVS Vision được tính phí theo số lượt sử dụng. Mỗi lượt sử dụng được tính là một lần gửi hình ảnh giấy tờ tùy thân, gồm mặt trước và mặt sau (nếu có) lên CVS Vision API và nhận được kết quả là thông tin trích xuất thành công từ hình ảnh gửi lên. Nếu doanh nghiệp của bạn có số lượng lớn giấy tờ cần xử lý, hãy liên hệ với chúng tôi để có giải pháp sử dụng tối ưu nhất cho doanh nghiệp của bạn."
    },
    {
      header:
...
export const BenefitDataSource = {
  ...
  content1: [
    ...
    {
      img: <img src="/benefit02.svg" alt="img" />,
      title: "Nhanh hơn 20 lần nhập thủ công"
    },
    {
