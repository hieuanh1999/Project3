...
export const BannerDataSource = {
    ...
    children: [
      {
        ...
        children: <p>ID Card Cambodia</p>
      },
      {
        name: "content",
        className: "banner5-description",
        children: <p>Nhận diện thông tin từ ảnh chụp ID Card Cambodia</p>
      },
      {
        name: "button",
  ...
  image: {
    ...
    children: "/banner12.jpg"
  },
  image2: {
    className: "banner5-image",
    children: "/banner12_1.jpg"
  }
};
...
export const FAQDataSource = {
  ...
  content: [
    ...
    {
      header: "Sản phẩm nhận diện ID Card Cambodia được tính phí thế nào?",
      key: "4",
      text:
        "Thông thường các sản phẩm của CVS Vision được tính phí theo số lượt sử dụng. Mỗi lượt sử dụng được tính là một lần gửi hình ảnh của ID Card Cambodia lên CVS Vision API và nhận được kết quả là thông tin trích xuất thành công từ hình ảnh gửi lên. Nếu doanh nghiệp của bạn có số lượng lớn giấy tờ cần xử lý, hãy liên hệ với chúng tôi để có giải pháp sử dụng tối ưu nhất cho doanh nghiệp của bạn."
    },
    {
      header:
