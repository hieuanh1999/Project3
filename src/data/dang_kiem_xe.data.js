...
export const BannerDataSource = {
    ...
    children: [
      {
        ...
        children: <p>Nhận diện đăng kiểm xe</p>
      },
      {
        name: "content",
        ...
        children: (
          <p>
            Nhận diện và trích xuất thông tin từ hình ảnh của giấy đăng kiểm xe
            ô tô
          </p>
        )
      },
  ...
  image: {
    ...
    children: "/banner5.jpg"
  },
  image2: {
    className: "banner5-image",
    children: "/banner5_1.jpg"
  }
};
...
export const FAQDataSource = {
  ...
  content: [
    ...
    {
      header: "Sản phẩm Nhận diện giấy đăng kiểm xe được tính phí thế nào?",
      key: "4",
      text:
        "Thông thường các sản phẩm của CVS Vision được tính phí theo số lượt sử dụng. Mỗi lượt sử dụng được tính là một lần gửi hình ảnh giấy đăng kiểm xe lên CVS Vision API và nhận được kết quả là thông tin trích xuất thành công từ hình ảnh gửi lên. Nếu doanh nghiệp của bạn có số lượng lớn giấy tờ cần xử lý, hãy liên hệ với chúng tôi để có giải pháp sử dụng tối ưu nhất cho doanh nghiệp của bạn."
    },
    {
      header:
