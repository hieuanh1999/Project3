...
export const BannerDataSource = {
    ...
    children: [
      {
        ...
        children: <p>Dữ liệu dạng bảng</p>
      },
      {
        name: "content",
        ...
        children: (
          <p>
            Nhận diện và trích xuất thông tin từ hình ảnh của các loại dữ liệu
            dạng bảng như báo cáo tài chính, bảng kê viện phí, bảng điểm, sao kê
            ngân hàng...
          </p>
        )
      },
  ...
  image: {
    ...
    children: "/banner10.jpg"
  },
  image2: {
    className: "banner5-image",
    children: "/banner10_1.jpg"
  }
};
    ...
    children: [
      {
        ...
        xs: 24,
        children: {
          to: "/products/ocr/business-registration-certificate",
          imgSource: "/related12.jpg",
          title: "Nhận diện giấy đăng ký doanh nghiệp",
          description:
            "Nhận diện và trích xuất thông tin từ hình ảnh của giấy đăng ký doanh nghiệp"
        }
      },
...
export const FAQDataSource = {
  ...
  content: [
    ...
    {
      header:
        "Sản phẩm Nhận diện giấy dữ liệu dạng bảng được tính phí thế nào?",
      key: "4",
      text:
        "Sản phẩm Nhận diện giấy dữ liệu dạng bảng được tính phí theo số trang nhận diện thành công. Nếu doanh nghiệp của bạn có số lượng lớn giấy tờ cần xử lý, hãy liên hệ với chúng tôi để có giải pháp sử dụng tối ưu nhất cho doanh nghiệp của bạn."
    },
    {
      header:
...
export const BenefitDataSource = {
  ...
  content1: [
    ...
    {
      img: <img src="/benefit11.svg" alt="img" />,
      title: "Tốc độ xử lý/Trang"
    }
  ],
  content2: [
    {
